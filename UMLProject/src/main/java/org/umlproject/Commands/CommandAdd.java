...
public class CommandAdd extends BaseCommand
{
    ...
    public void act(String[] args)
    {
        ...
        switch (args[0]) 
        {
            ...
            case "field"->{
                if(args.length == 5)
                {
                    ...
                    else
                    {
                        ...
                        DataType dataType = DataType.stringToDatatype(args[3]);
                        Visibility visibility = Visibility.stringVisibility(args[2]);
                        UMLDataField field = (dataType.equals(DataType.OTHER))? new UMLDataField(fieldName, args[3]) : new UMLDataField(fieldName, dataType);
            ...
            case "param"->{
                //add param Burger Eat int Hungry
                if(args.length <= 4)
                {
                    System.out.println("""
